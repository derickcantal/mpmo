        ...
        <div class="mx-auto sm:px-6 lg:px-8">
            ...
            <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                <div class="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-left mx-4 py-4 dark:border-gray-700 ">
                    <a href="{{ route('managetxn.convert') }}" class="flex items-center px-4 py-2 bg-orange-500 text-white font-semibold rounded-full shadow hover:bg-orange-600 focus:outline-none focus:ring-4 focus:ring-orange-300 transition">
                    ...
                    <a href="{{ route('managetxn.deposit') }}" class="flex items-center px-4 py-2 bg-pink-500 text-white font-semibold rounded-full shadow hover:bg-pink-600 focus:outline-none focus:ring-4 focus:ring-pink-300 transition">
                        <svg class="h-3.5 w-3.5 mr-1.5 -ml-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 15v2a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3v-2m-8 1V4m0 12-4-4m4 4 4-4"/>
                        </svg>
                        Deposit
                    </a>
                    <a href="{{ route('managetxn.withdraw') }}" class="flex items-center px-4 py-2 bg-green-500 text-white font-semibold rounded-full shadow hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-green-300 transition">
                        <svg class="h-3.5 w-3.5 mr-1.5 -ml-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
